...
def main():
	...
	splits = ['test-dev2015', 'train2014', 'val2014', 'test2015', 'train+val']
	...
	for split in splits:
		if s == 'train2014':
			...
			val_loader = data.get_loader(test=True, test_split=s)
		
		facts = run(detector_net, val_loader, tracker, prefix=s, top=10)
		saved_for_test(val_loader, facts, s)
